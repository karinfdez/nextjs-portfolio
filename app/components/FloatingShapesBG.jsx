...
const FloatingShapesBG = () => {
  ...
  return (
    // Fixed to viewport; sits behind content; ignores pointer events
    <div className="pointer-events-none fixed inset-0 -z-10 w-full" aria-hidden="true">
      {/* Center an inner container so absolute children can align to a max width */}
      <div className="relative h-full max-w-[1700px] mx-auto">
        {/* Orange soft ring (top-left) */}
        <motion.div
          className="absolute top-20 md:top-52 lg:top-52 right-4 md:right-auto left-auto md:left-4 xl:left-12"
          variants={float}
          animate="animate"
        >
        ...
        >
          <svg width="160" height="160" viewBox="0 0 160 160" className="opacity-30">
            <path d="M80 10 L140 45 L140 115 L80 150 L20 115 L20 45 Z" fill="none" className="stroke-[2] stroke-orange-500/70" />
          </svg>
        </motion.div>
        ...
        >
          <svg width="120" height="120" viewBox="0 0 160 160" className="opacity-15">
            <path d="M80 20 L132 50 L132 110 L80 140 L28 110 L28 50 Z" fill="none" className="stroke-[1.5] stroke-orange-500/70" />
          </svg>
        </motion.div>
